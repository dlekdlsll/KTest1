                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           	<label>제목</label>
                           	<input class="form-control" type="text" name="title" value="${board.title}" readonly><br>
                           	
                           	<label>내용</label>
                           	<textarea class="form-control" name="content" rows="10" readonly>${board.content}</textarea><br>
